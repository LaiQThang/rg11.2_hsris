		...
		<div className={cx('wrapper')}>
			...
			<form className={cx('login')} method="post">
				...
				<div className={cx('box-account')}>
					...
					<input
						type="text"
						value={users ? users.username : username}
						onChange={handleUserChange}
						className={cx('plh-account')}
				...
				<div className={cx('container-fpw')}>
					...
					<div className={cx('modal')}>
						...
						<div className={cx('modal-pw')}>
							<div className={cx('icon-check')}>
								<div className={cx('round-check')}>
									{' '}
									<FontAwesomeIcon className={cx('icon-inside')} icon={faCircleCheck} />
								</div>
							</div>
							...
							<button className={cx('btn-reLogin')} onClick={handleBackLogin}>
								Quay lại đăng nhập
							</button>
						</div>
					</div>
