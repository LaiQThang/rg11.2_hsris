	...
	return (
		<div className={cx('container')}>
			...
			<div className={cx('wrapper')}>
				<div className={cx('header')}>Hoạt động - Danh sách các giảng viên</div>
							...
							<tbody>
								{displayedData.map((data,index)=>(
									<tr className={cx('table-inner-row')} key ={index}>
										...
										<td className={cx('table-inner-row-content')}>
										<Link to ={`/showDetailTeacher/${data.idGV}`} className={cx('link')}><div className = {cx('button')}>Xem</div></Link>
										</td>
