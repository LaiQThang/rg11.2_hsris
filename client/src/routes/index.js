...
import showDetailTeacher from '~/pages/headerPages/showDetailTeacher/showDetailTeacher';
const publicRoutes = [
	...
	{ path: config.routes.showDetailTeacher, component: showDetailTeacher, auth: RequireAuth },
